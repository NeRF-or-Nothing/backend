...
def run_colmap(colmap_path, images_path, output_path, use_gpu="false"):
    ...
    try:
        ...
        logger.info("Features Extracted, Gpu: " + use_gpu)
    except:
    ...
    try:
        ...
        subprocess.call([colmap_path, "sequential_matcher",f"--SiftMatching.use_gpu={use_gpu}", "--database_path", database_path])
        logger.info("Feature Matched, Gpu: " + use_gpu)
    except:
